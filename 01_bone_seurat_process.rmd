---
title: "Flocculus Bone Single-Cell RNA-seq process"
author: "Yiran Li"
...
input_bone_WT1<-'./common/Yiran/Project/TBX1/bone_WT1'
input_bone_WT2<-'./common/Yiran/Project/TBX1/bone_WT2'
input_bone_MUT1<-'./common/Yiran/Project/TBX1/bone_MUT1'
input_bone_MUT1<-'./common/Yiran/Project/TBX1/bone_MUT2'
...
filepaths <- list(input_bone_WT1, input_bone_WT2, input_bone_MUT1, input_bone_MUT2)
sample_names <- c("bone_WT1", "bone_WT2", "bone_MUT1", "bone_MUT2")
...
soup_filepaths <- list(
  path_WT1 = file.path(input_bone_WT1, "outs/raw_feature_bc_matrix/"),
  path_WT2 = file.path(input_bone_WT2, "outs/raw_feature_bc_matrix/"),
  path_MUT1 = file.path(input_bone_MUT1, "outs/raw_feature_bc_matrix/"),
  path_MUT2 = file.path(input_bone_MUT2, "outs/raw_feature_bc_matrix/")
)
...
sample_names <- list(WT1 = 'bone_WT1', WT2 = 'bone_WT2', MUT1 = 'bone_MUT1', MUT2 = 'bone_MUT2')
